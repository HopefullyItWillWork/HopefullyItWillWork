...
const EPILOGUE = ';globalThis.__X={' + [
  ...
  'raterScore','raterVal','raterPair','raterMin','raterHasMin','rScale','RMING','RSHOOT','RDOWN','RCATS',
  ...
  'LEAGUEDEF','LEAGUEMAX','BIDUI','NOMUI','mleStamp','MLEDEF','mleAmt','mleSpent','usesMle','mleCost','addlList','matchOn','normCfg','tenureOf','cutAboveMin','faPool','signedClub','TEAMS','headcount',
