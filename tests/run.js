...
const EPILOGUE = ';globalThis.__X={' + [
  ...
  'LEAGUEDEF','LEAGUEMAX','BIDUI','NOMUI','mleStamp','MLEDEF','mleAmt','mleSpent','usesMle','addlList','matchOn','normCfg','tenureOf','cutAboveMin','faPool','signedClub','TEAMS','headcount',
